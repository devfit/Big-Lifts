...
biglifts.models.startingstrength.workouts.standard = {
    squat: [
        ...
        {sets: 3, reps: 5, name: 'A', percentage: 100, warmup: false, order: 4, groupOrder: 0},
        ...
        {sets: 3, reps: 5, name: 'B', percentage: 100, warmup: false, order: 4, groupOrder: 0}
    ],
    bench: [
        {sets: 2, reps: 5, name: 'A', percentage: 0, warmup: true, order: 0},
        ...
        {sets: 3, reps: 5, name: 'A', percentage: 100, warmup: false, order: 4, groupOrder: 1}
    ],
    deadlift: [
        ...
        {sets: 1, reps: 5, name: 'A', percentage: 100, warmup: false, order: 3, groupOrder: 2}
    ],
    press: [
        {sets: 2, reps: 5, name: 'B', percentage: 0, warmup: true, order: 0},
        ...
        {sets: 3, reps: 5, name: 'B', percentage: 100, warmup: false, order: 4, groupOrder: 1}
    ],
    powerclean: [
        {sets: 2, reps: 5, name: 'B', percentage: 0, warmup: true, order: 0},
        {sets: 1, reps: 5, name: 'B', percentage: 55, warmup: true, order: 1},
        {sets: 1, reps: 3, name: 'B', percentage: 70, warmup: true, order: 2},
        {sets: 1, reps: 2, name: 'B', percentage: 85, warmup: true, order: 3},
        {sets: 5, reps: 3, name: 'B', percentage: 100, warmup: false, order: 4, groupOrder: 2}
    ]
};
...
biglifts.models.startingstrength.workouts.novice = {
    ...
    deadlift: [
        ...
        {sets: 1, reps: 5, name: 'B', percentage: 100, warmup: false, order: 3, groupOrder: 2}
    ]
};