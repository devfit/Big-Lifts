...
Ext.define("biglifts.views.EditLogEntry", {
    ...
    bindListeners: function () {
        biglifts.stores.w.Settings.addListener('beforesync', this.rebuildEditLogFieldset, this);
    },
    destroyListeners: function () {
        biglifts.stores.w.Settings.removeListener('beforesync', this.rebuildEditLogFieldset, this);
    },
    config: {
        scroll: 'vertical',
        ...
        listeners: {
            painted: function () {
                ...
                if (!this._painted) {
                    this._painted = true;
                    this.bindListeners();
                    Ext.get('edit-log-notes').addListener('tap', this.editNotes, this);
                }
            },
            destroy: function () {
