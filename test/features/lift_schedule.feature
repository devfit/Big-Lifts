Feature: lifter sets max
  ...
  Scenarios: different lifts
    ...
    | squat | 300 | 1    | 5 110 40% | 5 135 50% | 3 160 60% | 5 175 65% | 5 205 75% | 5 230 85% |
    | squat | 300 | 2    | 5 110 40% | 5 135 50% | 3 160 60% | 3 190 70% | 3 215 80% | 3 245 90% |
    | squat | 300 | 3    | 5 110 40% | 5 135 50% | 3 160 60% | 5 205 75% | 3 230 85% | 1 255 95% |
    | squat | 300 | 4    | 5 110 40% | 5 135 50% | 3 160 60% | 5 110 40% | 5 135 50% | 5 160 60% |
    | press | 125 | 3    | 5 45 40%  | 5 55 50%  | 3 70 60%  | 5 85 75%  | 3 95 85%  | 1 105 95% |
